...
export default function Topbar() {
  ...
  >
    <Toolbar>
      ...
      variant="outlined" onClick={handleClickOpenSB}>
      <SearchOutlinedIcon 
       sx={{
      ...
      <Dialog open={openSB} onClose={handleCloseSB} >
        ...
        <DialogContent>
          ...
          > <strong><TipsAndUpdatesOutlinedIcon 
       sx={{
        marginBottom:'-8px',
        color: colorConfigs.sidebar.color,
        fontSize:'25px',
       ...
       />    Tip.</strong>Search by entering a keyword and pressing Enter</Box>  
          </DialogContentText>
          <TextField 
          autoFocus
          id="outlined-basic"
        ...
        <DialogActions>
          <Button onClick={handleCloseSB}  variant="text">Cancel</Button>
